              ...
              {user ? (
                alreadySaved ? (
                  ...
                  <button
                    ...
                    className="bg-red-500 opacity-70 hover:opacity-100 text-white font-bold px-5 py-1 text-base rounded-3xl hover:shadow-md outline-none "
                  >
                    {save?.length} {alreadySaved ? "Saving" : "Save"}
                  </button>
                )
              ) : (
                <></>
            ...
            <div className="flex justify-between items-center gap-2 w-full">
              {destination && (
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="bg-white flex items-center gap-2 text-black font-bold pl-4 p-2 pr-4 rounded-full opacity-70 hover:100 hover:shadow-md "
                >
